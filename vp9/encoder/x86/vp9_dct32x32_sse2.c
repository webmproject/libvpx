    ...
    for (column_start = 0; column_start < 32; column_start += 8) {
      ...
      if (0 == pass) {
        ...
        }
        {
          ...
          overflow = check_epi16_overflow_x8(step1[4], step1[5], step1[6],
                        step1[7], step1[24], step1[25], step1[26], step1[27]);
          if (overflow) {
            HIGH_FDCT32x32_2D_ROWS_C(intermediate, output_org);
            return;
          }
        ...
        }
        {
          ...
          overflow = check_epi16_overflow_x8(step1[8], step1[9], step1[10],
                        step1[11], step1[20], step1[21], step1[22], step1[23]);
          if (overflow) {
            HIGH_FDCT32x32_2D_ROWS_C(intermediate, output_org);
            return;
          }
        ...
        }
        {
          ...
          overflow = check_epi16_overflow_x8(step1[12], step1[13], step1[14],
                        step1[15], step1[16], step1[17], step1[18], step1[19]);
          if (overflow) {
            HIGH_FDCT32x32_2D_ROWS_C(intermediate, output_org);
            return;
          }
...
#if DCT_HIGH_BIT_DEPTH
        overflow = check_epi16_overflow_x16(step2[0], step2[1], step2[2],
                        step2[3], step2[4], step2[5], step2[6], step2[7],
                        step2[8], step2[9], step2[10], step2[11], step2[12],
                        step2[13], step2[14], step2[15]);
        if (overflow) {
          if (pass == 0)
      ...
      }
      {
        ...
        overflow = check_epi16_overflow_x8(step2[20], step2[21], step2[22],
                        step2[23], step2[24], step2[25], step2[26], step2[27]);
        if (overflow) {
          if (pass == 0)
            HIGH_FDCT32x32_2D_C(input, output_org, stride);
          else
...
#if DCT_HIGH_BIT_DEPTH
        overflow = check_epi16_overflow_x32(step2[0], step2[1], step2[2],
                        step2[3], step2[4], step2[5], step2[6], step2[7],
                        step2[8], step2[9], step2[10], step2[11], step2[12],
                        step2[13], step2[14], step2[15], step1[16], step1[17],
                        step1[18], step1[19], step2[20], step2[21], step2[22],
                        step2[23], step2[24], step2[25], step2[26], step2[27],
      ...
      // Stage 3
      {
        ...
        overflow = check_epi16_overflow_x8(step3[0], step3[1], step3[2],
                       step3[3], step3[4], step3[5], step3[6], step3[7]);
        if (overflow) {
          if (pass == 0)
            HIGH_FDCT32x32_2D_C(input, output_org, stride);
          else
...
#if DCT_HIGH_BIT_DEPTH
        overflow = check_epi16_overflow_x16(step3[16], step3[17], step3[18],
                        step3[19], step3[20], step3[21], step3[22], step3[23],
                        step3[24], step3[25], step3[26], step3[27], step3[28],
                        step3[29], step3[30], step3[31]);
        if (overflow) {
          if (pass == 0)
            HIGH_FDCT32x32_2D_C(input, output_org, stride);
          else
...
#if DCT_HIGH_BIT_DEPTH
        overflow = check_epi16_overflow_x16(step1[0], step1[1], step1[2],
                        step1[3], step1[4], step1[5], step1[6], step1[7],
                        step1[8], step1[9], step1[10], step1[11], step1[12],
                        step1[13], step1[14], step1[15]);
        if (overflow) {
          if (pass == 0)
            HIGH_FDCT32x32_2D_C(input, output_org, stride);
          else
      ...
      }
      {
        ...
        overflow = check_epi16_overflow_x8(step1[18], step1[19], step1[20],
                        step1[21], step1[26], step1[27], step1[28], step1[29]);
        if (overflow) {
          if (pass == 0)
            HIGH_FDCT32x32_2D_C(input, output_org, stride);
          else
...
#if DCT_HIGH_BIT_DEPTH
        overflow = check_epi16_overflow_x16(step2[16], step2[17], step2[18],
                        step2[19], step2[20], step2[21], step2[22], step2[23],
                        step2[24], step2[25], step2[26], step2[27], step2[28],
                        step2[29], step2[30], step2[31]);
        if (overflow) {
          if (pass == 0)
            HIGH_FDCT32x32_2D_C(input, output_org, stride);
          else
      ...
      }
      {
        ...
        overflow = check_epi16_overflow_x8(step3[8], step3[9], step3[10],
                        step3[11], step3[12], step3[13], step3[14], step3[15]);
        if (overflow) {
          if (pass == 0)
            HIGH_FDCT32x32_2D_C(input, output_org, stride);
          else
      ...
      }
      {
        ...
        overflow = check_epi16_overflow_x8(step3[17], step3[18], step3[21],
                        step3[22], step3[25], step3[26], step3[29], step3[30]);
        if (overflow) {
          if (pass == 0)
            HIGH_FDCT32x32_2D_C(input, output_org, stride);
          else
...
#if DCT_HIGH_BIT_DEPTH
        overflow = check_epi16_overflow_x16(step1[16], step1[17], step1[18],
                        step1[19], step1[20], step1[21], step1[22], step1[23],
                        step1[24], step1[25], step1[26], step1[27], step1[28],
                        step1[29], step1[30], step1[31]);
        if (overflow) {
          if (pass == 0)
            HIGH_FDCT32x32_2D_C(input, output_org, stride);
          else
...
#if DCT_HIGH_BIT_DEPTH
          overflow = k_check_epi32_overflow_16(v[0], v[1], v[2], v[3], v[4],
                        v[5], v[6], v[7], v[8], v[9], v[10], v[11], v[12],
                        v[13], v[14], v[15], &kZero);
          if (overflow) {
            HIGH_FDCT32x32_2D_ROWS_C(intermediate, output_org);
            return;
          }
