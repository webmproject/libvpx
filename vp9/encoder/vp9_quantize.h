...
typedef struct {
  ...
  DECLARE_ALIGNED(16, tran_low_t,
                  y_cumbins_nuq[QUANT_PROFILES][QINDEX_RANGE][COEF_BANDS]
                               [NUQ_KNOTS]);
  DECLARE_ALIGNED(16, tran_low_t,
                  uv_cumbins_nuq[QUANT_PROFILES][QINDEX_RANGE][COEF_BANDS]
                                [NUQ_KNOTS]);
...
#if CONFIG_NEW_QUANT
  DECLARE_ALIGNED(16, tran_low_t,
                  y_cumbins_nuq_pxd[QUANT_PROFILES][QINDEX_RANGE][COEF_BANDS]
                                   [NUQ_KNOTS]);
  DECLARE_ALIGNED(16, tran_low_t,
                  uv_cumbins_nuq_pxd[QUANT_PROFILES][QINDEX_RANGE][COEF_BANDS]
                                    [NUQ_KNOTS]);
#endif  // CONFIG_NEW_QUANT
