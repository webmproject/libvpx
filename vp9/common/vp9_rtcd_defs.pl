...
if (vpx_config("CONFIG_REALTIME_ONLY") ne "yes") {
  ...
  specialize qw/vpx_convolve12_vert ssse3 avx2 neon neon_dotprod/;
  ...
  specialize qw/vpx_convolve12_horiz ssse3 avx2 neon neon_dotprod/;
  ...
  specialize qw/vpx_convolve12 ssse3 avx2 neon/;
