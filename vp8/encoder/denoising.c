...
int vp8_denoiser_allocate(VP8_DENOISER *denoiser, int width, int height,
  ...
  for (i = 0; i < MAX_REF_FRAMES; ++i) {
    ...
    bzero(denoiser->yv12_running_avg[i].buffer_alloc,
  ...
  bzero(denoiser->yv12_mc_running_avg.buffer_alloc,
  ...
  bzero(denoiser->yv12_last_source.buffer_alloc,
  ...
  bzero(denoiser->denoise_state, (num_mb_rows * num_mb_cols));
