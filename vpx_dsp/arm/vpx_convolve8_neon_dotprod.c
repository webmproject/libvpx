...
void vpx_convolve8_neon_dotprod(const uint8_t *src, ptrdiff_t src_stride,
  ...
  vpx_convolve_8tap_2d_horiz_neon_dotprod(src - horiz_offset - vert_offset,
                                          src_stride, im_block, im_stride, w,
                                          im_height, x_filter_8tap);

  vpx_convolve_8tap_vert_neon_dotprod(im_block, im_stride, dst, dst_stride, w,
                                      h, y_filter_8tap);
}
...
void vpx_convolve8_avg_neon_dotprod(const uint8_t *src, ptrdiff_t src_stride,
  ...
  vpx_convolve8_2d_horiz_neon_dotprod(
      ...
      x0_q4, x_step_q4, y0_q4, y_step_q4, w, im_height);

  vpx_convolve8_avg_vert_neon_dotprod(im_block + im_stride * border_offset,
