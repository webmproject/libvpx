...
d8="--disable-smooth_hv --disable-parallel_deblocking --disable-rect_intra_pred"
d9="--disable-convolve_round --disable-aom-qm --disable-palette_throughput"
d10="--disable-tempmv_signaling"
